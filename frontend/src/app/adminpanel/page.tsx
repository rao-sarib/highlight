...
import { Loader2, Lock, LogOut, Plus, RotateCcw, Save, Send, Trash2 } from "lucide-react";
...
const USER_ROLES = ["seo_expert", "content_writer", "analytics_manager"];
const PLAN_KEYS = ["free", "pro", "pro_plus", "enterprise"];

const ICON_OPTIONS = ["Gauge", "ScanSearch", "FileText", "Swords", "Search", "ClipboardList"];

// ── Small field components (module scope so inputs keep focus) ─────────────
function Field({
  label,
  value,
  onChange,
